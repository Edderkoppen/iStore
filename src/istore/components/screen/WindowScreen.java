package istore.components.screen;

import istore.components.menus.MenuBarSample;
import istore.components.menus.SplitPaneSample;
import istore.components.menus.TreeSample;
import istore.components.pages.*;
...
public class WindowScreen extends JFrame {
    ...
    public WindowScreen(int width, int height) {
        ...
        this.setIconImage(new ImageIcon("src/istore/assets/images/iStore.png").getImage());
